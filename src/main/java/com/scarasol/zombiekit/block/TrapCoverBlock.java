...
public class TrapCoverBlock extends Block {
    ...
    public void checkNeighbor(Level world, BlockPos pos){
        ...
        for (double i = x - 1; i <= x + 1; i++){
            BlockPos neighbor1 = new BlockPos(i, y, z);
        ...
        for (double k = z - 1; k <= z + 1; k++){
            BlockPos neighbor2 = new BlockPos(x, y, k);
    ...
    public static void registerRenderLayer() {
        ItemBlockRenderTypes.setRenderLayer(ZombieKitBlocks.TRAP_COVER.get(), renderType -> renderType == RenderType.cutout());
    }
    ...
    public static void blockColorLoad(ColorHandlerEvent.Block event) {
        ...
        }, ZombieKitBlocks.TRAP_COVER.get());
    }
