...
public class BileJar extends Item {
    public BileJar(Properties properties) {
        super(properties);
    }
    ...
    public void releaseUsing(ItemStack itemStack, Level world, LivingEntity entityLiving, int timeLeft) {
        if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
            AbstractArrow entityArrow = BileJarEntity.shoot(world, entity, world.getRandom(), 0.8f, 4, 0);
