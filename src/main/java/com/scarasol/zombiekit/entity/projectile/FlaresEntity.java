...
public class FlaresEntity extends ModProjectile{
    ...
    public void onHitBlock(BlockHitResult blockHitResult) {
        ...
        if (blockState.isAir() || blockState.getBlock() instanceof SnowLayerBlock || blockState instanceof IPlantable){
            ...
            if (blockState2.isAir() || blockState2.getBlock() instanceof SnowLayerBlock || blockState2 instanceof IPlantable){
