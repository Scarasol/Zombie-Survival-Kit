...
public class ZombieKitItems {
    ...
    public static final RegistryObject<Item> KONN_GARA = REGISTRY.register("konn_gara", () -> new KonnGara(0, () -> ZombieKitSounds.konn_gara.get(), new Item.Properties().tab(null).rarity(Rarity.EPIC), 100));
