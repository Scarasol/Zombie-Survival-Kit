...
public class ZombieKitTags {
    public static final ResourceKey<Structure> STRUCTURE = ResourceKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("zombiekit:prison"));
    ...
    public static final TagKey<Structure> SHELTER = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation("zombiekit:shelter"));
}
