    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        ...
        if (entity != null && ExoArmor.numberOfSuit(entity) >= 4) {
            ...
            if (!entity.isSpectator()) {
                ...
                Minecraft.getInstance().gui.blit(event.getPoseStack(), posX, posY, 0, 0, 112, 35, 112, 35);
                ...
                Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 80, posY + 12, 0, 0, 5, 8, 5, 8);
                RenderSystem.setShaderTexture(0, new ResourceLocation("zombiekit:textures/screens/exo/" + color + "/" + power % 100 / 10 + ".png"));
                Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 87, posY + 12, 0, 0, 5, 8, 5, 8);
                RenderSystem.setShaderTexture(0, new ResourceLocation("zombiekit:textures/screens/exo/" + color + "/" + power % 10 + ".png"));
                Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 94, posY + 12, 0, 0, 5, 8, 5, 8);

                RenderSystem.setShaderTexture(0, new ResourceLocation("zombiekit:textures/screens/exo/" + color + "/percent.png"));
                Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 101, posY + 12, 0, 0, 5, 8, 5, 8);
                ...
                for (int i = 0; power / ((i + 1) * 5) > 0; i++){
                    ...
                    Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 103 - 5 * i, posY + 21, 0, 0, 3, 8, 3, 8);
                }
                ...
                if (ExoArmor.getRadar(itemStack)){
                    ...
                    Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 96, posY + 2, 0, 0, 8, 8, 8, 8);
                }

                if (entity.isFallFlying()){
                    RenderSystem.setShaderTexture(0, new ResourceLocation("zombiekit:textures/screens/exo/" + color + "/fall_fly.png"));
                    Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 86, posY + 2, 0, 0, 8, 8, 8, 8);
                }
                ...
                if (ExoArmor.getReactiveArmor(itemStack) >= 0){
                    ...
                    Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 76, posY + 2, 0, 0, 8, 8, 8, 8);
                    RenderSystem.setShaderTexture(0, new ResourceLocation("zombiekit:textures/screens/exo/" + color + "/reactive_armor.png"));
                    Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 76, posY + 2, 0, 0, 8, 8 * ExoArmor.getReactiveArmor(itemStack) / 160, 8, 8);
                }
            }
